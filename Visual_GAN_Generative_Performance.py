...
games = os.listdir('Visual_Results')
...
for game in games:
    print(game)
    folders = os.listdir(f'Visual_Results/{game}')
    model_names_list = [folder for folder in folders if folder != 'Examples']
    for model in model_names_list:
        print(f'\t{model}')
        runs = os.listdir(f'Visual_Results/{game}/{model}')
        for run in runs:
            results = dict()
            # print(f'\t\t{run}')
            files = os.listdir(f'Visual_Results/{game}/{model}/{run}')
            if 'performance_results.csv' in files:
                ...
                results['filepath'] = f'Visual_Results/{game}/{model}/{run}'
